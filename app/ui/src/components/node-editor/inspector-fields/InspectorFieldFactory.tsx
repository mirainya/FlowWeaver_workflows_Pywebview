...
import { InspectorInput, InspectorKeyInput, InspectorNumber, InspectorSelect, InspectorArrayEditor } from './InspectorWidgets';
...
export default function InspectorFieldFactory({ step, update }: Props) {
  switch (step.kind) {
    case 'key_tap':
      return (
        <>
